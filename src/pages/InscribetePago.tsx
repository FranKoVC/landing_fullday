...
import StepMetodoPago from "../components/steps/StepMetodoPago";
import StepFormPago from "../components/steps/StepFormPago";

const InscribetePago: React.FC = () => {
  return (
