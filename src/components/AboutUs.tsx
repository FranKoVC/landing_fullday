...
const teamMembersData = [
  {
    ...
    {
      "id": 2,
      "imageUrl": "/src/assets/estudiante2.png",
    ...
    },
    {
      ...
      "description": "Enfocado en ciberseguridad, desarrollo de software y proyectos tecnológicos con impacto social. Apasionado por la innovación, el análisis y la mejora continua.",
      "role": "Desarrollador Full-Stack | UIX | Data Ingenieer",
      "socialLinks": {
        "linkedin": "https://www.linkedin.com/in/eriks-arqueros-lezama-164610268/",
        "github": "https://github.com/EriksHudson"
      }
    },
    {
      "id": 4,
      "imageUrl": "/src/assets/estudiante4.png",
      "name": "Avila Rebaza Sergio Fernando",
      "description": "Desarrollador web full-stack especializado en backend, arquitectura escalable y APIs. Sólidos conocimientos en IA aplicada para automatizar procesos y potenciar soluciones eficientes, seguras y orientadas a resultados.",
      "role": "Desarrollador Full-Stack | Backend | Arquitecturas Escalables | Rest APIs | IA | SQL",
      "socialLinks": {
    ...
    },
    {
      ...
      "description": "Ingeniero Full Stack apasionado por la convergencia entre desarrollo web y nuevas tecnologías. Combino una sólida arquitectura backend con IA aplicada para optimizar procesos, reducir tiempos de desarrollo y crear soluciones digitales inteligentes y orientadas al futuro.",
    ...
    },
    {
      ...
      "description": "Desarrollador full-stack y mobile con experiencia en soluciones end to end. Especializado en automatización con IA, machine learning, deep learning, business intelligence e integración de dispositivos y plataformas IoT.",
      "role": "Full-Stack & Mobile Developer | IA/ML/DL | Business Intelligence | IoT | Ponente",
      "socialLinks": {
        "linkedin": "linkedin.com/in/alejandro-campos-gamarra-74a362219",
    ...
    },
    {
      ...
      "role": "Desarrollador Backend | APIS | SQL | Data Science | Python | N8N",
      "socialLinks": {
        "linkedin": "https://www.linkedin.com/in/marcos-ivan-diaz-tomas-9262682a7/",
    ...
    {
      "id": 12,
      "imageUrl": "/src/assets/estudiante12.png",
      "name": "Guevara Saldaña Rodrigo Alonso",
      "description": "Estudiante de Ingeniería de Sistemas con interés en ciberseguridad, ethical hacking y seguridad de la información, enfocado en aprender técnicas de análisis y explotación de vulnerabilidades y el fortalecimiento de sistemas informáticos.",
      "role": "Ciberseguridad | Ethical Hacking",
      "socialLinks": {
        "linkedin": "https://www.linkedin.com/in/rodrigo-guevara-saldana/",
    ...
    {
      "id": 15,
      "imageUrl": "/src/assets/estudiante15.png",
      "name": "Huamanchumo Gordillo Alexander Saul",
      "description": "Desarrollador Full Stack enfocado en soluciones financieras distribuidas, optimización de procesos críticos, alto rendimiento y diseño de servicios robustos con tecnologías modernas como Java, Spring Boot, microservicios, Docker y bases de datos relacionales.",
    ...
    },
    {
      ...
      "description": "Estudiante de decimo ciclo interesado y enfocado en desarrollador de software e investigador en inteligencia artificial. Experiencia en deep learning, visión por computadora, sistemas web y auditoría informática. asi mismo en soluciones académicas, científicas y empresariales.",
      "role": "Full Stack | IA | Deep Learning | Data Science | IoT | Ponente",
      "socialLinks": {
        "linkedin": "https://www.linkedin.com/in/francisco-gerardo-huamanchumo-trujillo",
    ...
    {
      "id": 19,
      "imageUrl": "/src/assets/estudiante19.png",
      "name": "Ordoñez Reyes Abraham Benjamin",
      "description": "Desarrollador Full Stack con enfoque en frontend y backend. Experto en React, Laravel y gestión de bases de datos (SQL Server, MySQL, PostgreSQL). Cuento con experiencia sólida en desarrollo de aplicaciones móviles.",
      "role": "Full-Stack Developer | Frontend & Backend | DB | Mobile Developer",
      "socialLinks": {
    ...
    {
      "id": 23,
      "imageUrl": "/src/assets/estudiante23.png",
      "name": "Quispe Sanchez Edward Steven",
      "description": "Desarollador Fronted Developer con experiencia en plataformas Web y Móvil. Materializo interfaces dinamicas con manejo de frameworks optimos y legilbes para el buen consumo del usuario. De igual manera cuento con manejo de herramientas para creación de proyectos de Machine Learning.",
      "role": "Desarrollador Fronted Dev | MVVM | Android Dev | ML",
      "socialLinks": {
    ...
    },
    {
      ...
      "description": "Desarrollador web full stack con Angular 20 y Django 5.2.",
    ...
    {
      "id": 28,
      "imageUrl": "/src/assets/estudiante28.png",
      "name": "Rodriguez Ponce Kevin Jose",
      "description": "Estudiante de Ingeniería de Sistemas en la UNT. Desarrollador Full Stack Jr y DevOps Jr con experiencia en SQL, despliegue de aplicaciones y automatización de aplicaciones.",
    ...
    },
    {
      ...
      "description": "Fulltstack Developer con experiencia en plataformas web y móviles mediante diversos lenguajes, enfocado en aportar soluciones prácticas, tecnológicas y de calidad. Soy amante del deporte y el trabajo en equipo.",
    ...
    },
    {
      ...
      "description": "Estudiante de Ingeniería de Sistemas con interés en el desarrollo de software y en la aplicación de tecnologías que aporten soluciones prácticas. Me caracterizo por aprender rápido, trabajar en equipo y buscar siempre mejorar mis habilidades a través de nuevos reto",
      "role": "Desarrollador Full Stack",
      "socialLinks": {
        "linkedin": "www.linkedin.com/in/edson-ugaz-1b89b5331",
    ...
    },
    {
      ...
      "description": "Desarrollador de software full stack con experiencia en Laravel, React y NestJS. Actualmente me desempeño en el desarrollo integral de un sistema de facturación y logística, abarcando tanto la programación como las tareas de DevOps.",
    ...
    },
    {
      ...
      "description": "Estudiante de 10° ciclo de Ing. de Sistemas, especializado en Desarrollo Frontend y Diseño UX. Cuento con conocimientos sólidos en Análisis de Datos, incluyendo Power BI y modelado ETL, lo que me permite abordar la resolución de problemas de forma integral",
      "role": "Desarrollador Frontend UX | Data Analyst (Power BI/ETL)",
      "socialLinks": {
        "linkedin": "www.linkedin.com/in/brahayan-venegas-723814355",
        "github": ""
      }
    },
    {
